"""
    ...
    @Description:       For this experiment, we will evaluate the performance of all hyper-parameter optimization
                        ...
                        (between 1 and 20) and finally layers size (number of neurons on each hidden layer between 5
                        and 50) with all methods available.
...
x_train, t_train, x_test, t_test = dm.load_forest_covertypes_dataset(random_state=42)
